...
const SuperAdminDashboard = () => {
  ...
  const renderOverview = () => (
    <div className="space-y-8">
      ...
      {/* Recent Exams */}
      <div className="bg-gradient-to-br from-green-100 to-green-200 backdrop-blur-xl border border-green-400 rounded-2xl p-6 shadow-xl">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-bold text-green-900" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
            সাম্প্রতিক পরীক্ষা
          </h3>
          <button 
            onClick={() => setActiveTab('exams')}
            className="text-green-800 hover:text-green-900 text-sm font-medium transition-colors bg-green-300 px-4 py-2 rounded-lg hover:bg-green-400 border border-green-500"
        ...
        <div className="space-y-4">
          {exams.slice(0, 3).map((exam) => (
            <div key={exam.id} className="bg-gradient-to-r from-green-50 to-green-100 border border-green-300 rounded-xl p-4 hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02]">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="text-lg font-semibold text-green-900" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
                    {exam.title}
                  </h4>
                  <p className="text-green-700 text-sm" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
                ...
                <div className="text-right">
                  <p className="text-green-800 font-bold" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
                    {exam.set_count} সেট
                  </p>
                  <p className="text-green-600 text-xs" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
      ...
      <div className="bg-gradient-to-br from-green-200 to-green-300 backdrop-blur-xl border border-green-500 rounded-2xl p-6 shadow-xl">
        <h3 className="text-2xl font-bold text-green-900 mb-6" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
          শ্রেণীভিত্তিক পরীক্ষা
        </h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {exams.map((exam) => (
            <div key={exam.id} className="bg-gradient-to-br from-green-100 to-green-200 border border-green-400 rounded-xl p-4 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              <div className="flex items-center justify-between mb-3">
                <h4 className="text-lg font-semibold text-green-900" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
                  {exam.class}
                </h4>
                <span className="bg-green-300 text-green-800 px-3 py-1 rounded-full text-xs font-medium border border-green-500">
                  {exam.set_count} সেট
                </span>
              </div>
              <p className="text-green-800 text-sm mb-2" style={{ fontFamily: "'Hind Siliguri', sans-serif" }}>
                {exam.title}
              </p>
